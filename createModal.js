export default function createModal() {
  document.querySelector("body").insertAdjacentHTML(
    ...
    `<div class='modal-container' aria-modal='true' role='dialog'>
        ...
        <button class="modal__btn modal__arrow modal_arrow-left" id="left" aria-label="Previous image"> 
        ...
        <button class="modal__btn modal__close"aria-label="Close artworks"> 
        <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.25 6.75L6.75 17.25"></path>
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6.75 6.75L17.25 17.25"></path>
      </svg>
      
        </button><button class="modal__btn modal__arrow modal_arrow-right" id="right" aria-label="Next image"> 
        <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        .modal__btn {
          ...
          place-items: center;
          color: hsl(var(--text));
          background-color: hsl(var(--bkg) / .6);
          padding: .5rem;
